# dwm desktop environment dynamic colorscheme change, based on wallpapers color analysis
# code writen by "Чёрный Треугольник" (https://www.youtube.com/@Black_Triangle)

import json

end_list = []

with open('/home/veprikov/.cache/wal/colors.json') as file:
...
file = open("/home/veprikov/.Xresources", "w")
